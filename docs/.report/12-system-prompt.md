...
- [`conversation.rs#L20-L26`](/rust/crates/runtime/src/conversation.rs#L20-L26) 定义了 `ApiRequest`，其 `system_prompt` 字段类型正是 `Vec<String>`。
...
- `LiveCli::new()` 在 [`main.rs#L3348-L3380`](/rust/crates/rusty-claude-cli/src/main.rs#L3348-L3379) 调用 `build_system_prompt()` 并将结果存入 `LiveCli` 和 `ConversationRuntime`。
...
- `ApiRequest` 定义在 [`conversation.rs#L20-L26`](/rust/crates/runtime/src/conversation.rs#L20-L26)。
...
- `detect_cache_break()` 在 [`prompt_cache.rs#L313-L383`](/rust/crates/api/src/prompt_cache.rs#L313-L382)，是缓存失效分析的核心。
